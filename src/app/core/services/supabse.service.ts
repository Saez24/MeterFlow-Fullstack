...
export class SupabaseService {
  ...
  private mapMeter = (d: any): MeterConfig => ({
    ...
    baseCharge: d.base_charge,
    wastewaterPrice: d.wastewater_price,
  ...
  private toDbMeter = (m: Partial<MeterConfig>) => ({
    ...
    ...(m.pricePerUnit !== undefined && { price_per_unit: m.pricePerUnit }),
    ...(m.baseCharge !== undefined && { base_charge: m.baseCharge }),
    ...(m.wastewaterPrice !== undefined && { wastewater_price: m.wastewaterPrice }),
